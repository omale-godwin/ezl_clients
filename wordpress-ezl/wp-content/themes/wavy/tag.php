    ...
    <div class="grid-container grid-medium np-tablet">    
        <div class="tag-description bg-box no-image">
            <div class="left grid-60 tablet-grid-60 np-mobile">
                ...
                <div class="total"><?php esc_html( printf( _n( '%1$s <span class="dot"></span> Article with this Tag', '%1$s &nbsp;<span class="dot"></span> Articles with this Tag', $obj->count, 'wavy'), number_format_i18n( $obj->count ) ) ); ?></div>
