...
?>
<div class="epcl-module-wrapper content grid-container <?php echo esc_attr($module_class); ?>" id="<?php echo wp_unique_id('epcl-grid-posts-'); ?>">
    ...
    <div class="epcl-row content-wrapper">
        ...
        <?php if( $custom_query->have_posts() ): ?>
            ...
            <!-- start: .articles -->
            <div class="articles grid-posts" data-columns="<?php echo absint($grid_posts_column); ?>">
