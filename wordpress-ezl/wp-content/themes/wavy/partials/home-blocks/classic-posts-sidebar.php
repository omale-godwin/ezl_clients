...
?>
<div class="module-wrapper grid-container <?php echo esc_attr($module_class); ?>">

    <!-- start: .content-wrapper -->
    <div class="content-wrapper classic classic-sidebar content" id="<?php echo wp_unique_id('epcl-classic-sidebar-'); ?>">
