...
<?php while(have_posts()): the_post();  ?>
	...
	?>
	<!-- start: #single -->
    <main id="single" class="main grid-container no-sidebar <?php echo esc_attr($post_style_class.$single_class); ?>" data-post-id="<?php the_ID(); ?>">
                        ...
                        <section class="post-content">
                            ...
                            <?php if( comments_open() ): ?>
                                <div id="go-to-comments" class="go-to-comments section textcenter">
                                    <a href="<?php the_permalink(); ?>#comments" rel="noamphtml" class="epcl-button large gradient-button wave-button"><?php esc_html_e('Leave a Comment', 'wavy'); ?></a>
                                </div>
                            <?php endif; ?>
