        ...
        <div class="grid-container">
            <div class="epcl-flex">
                ...
                <?php if( epcl_get_option('enable_search_header') == '1' || empty($epcl_theme) ): ?>
                    <a href="<?php echo home_url('/'); ?>?s=" class="epcl-search-button epcl-button gradient-button circle" aria-label="<?php esc_attr_e('Search', 'wavy'); ?>"><svg class="icon"><use xlink:href="<?php echo EPCL_THEMEPATH; ?>/assets/images/svg-icons.svg#search-icon"></use></svg></a>
                <?php endif; ?>
