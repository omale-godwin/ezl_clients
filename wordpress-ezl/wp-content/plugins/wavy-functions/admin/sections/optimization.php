...
CSF::createSection( $opt_name, array(
	...
	'fields' => array(
        ...
        array(
			...
			'type' => 'switcher',
            'title' => esc_html__('Enable Defer for Scripts', 'epcl_framework'),
            // 'subtitle' => esc_html__('W3 Total Cache plugin recommended', 'epcl_framework'),
			'desc' => esc_html__('This will add a "defer" attribute to Javascript files, reducing them the overall priority and CPU usage. If you are experiencing any error on the console, just disable this option.', 'epcl_framework'),
			'default' => false
        ),
        array(
			'id' => 'remove_emojis',
			'type' => 'switcher',
            'title' => esc_html__('Remove Emojis', 'epcl_framework'),
            // 'subtitle' => esc_html__('W3 Total Cache plugin recommended', 'epcl_framework'),
			'desc' => __('WordPress Emojis uses a minor Javascript to execute, removing them can improve the speed.<br> You will still see Emojis but only with a different style.', 'epcl_framework'),
			'default' => false
        ),
        array(
