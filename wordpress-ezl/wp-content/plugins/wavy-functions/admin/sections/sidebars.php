...
CSF::createSection( $opt_name, array(
	...
	'fields' => array(
		...
		array(
			...
			'desc' => __('Leave blank to use the default page sidebar.<br>You can add a new custom sidebar at the top of this page, then click save to see it here.', 'epcl_framework'),
            'options' => 'sidebars',
		...
		array(
			...
			'desc' => __('Select which Mobile Sidebar you want to display.<br>You can add a new custom sidebar at the top of this page, then click save to see it here.', 'epcl_framework'),
            'options' => 'sidebars',
            'placeholder' => esc_html__('Select Sidebar', 'epcl_framework'),
            'settings' => array(
                'width' => '200px',
            ),
            'dependency' => array('enable_mobile_footer_sidebar', '==', 'true'),
            'default' => 'epcl_sidebar_footer'
		),
	)
) );